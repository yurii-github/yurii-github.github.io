...
return [
    ...
    'Markups' => [
        ...
        ['(X)HTML 5', 9, false, 'https://html.spec.whatwg.org/multipage', ''],
        ['CSS 2/3', 5, false, '', ''],
        ['XML 1.0', 5, true, '', ''],
        ['XML 1.1', 1, false, '', ''],
        ['XSLT', 1, false, '', ''],
    ...
    'Languages' => [
        ...
        ['Assembly', 1, false, 'http://asm.sourceforge.net', ''],
    ...
    'JS Kits' => [
        ['DevExtreme', 1, false, 'https://js.devexpress.com/documentation', ''],
        ['Admin LTE', 4, false, 'https://adminlte.io/docs', ''],
        ['Webpack 4', 6, false, 'https://webpack.js.org/guides', ''],
    ...
    'PHP Frameworks' => [
        ...
        ['Laminas', 0, false, 'https://docs.laminas.dev', ''],
    ...
    'PHP Kits' => [
        ...
        ['ReactPHP', 5, false, 'https://reactphp.org', ''],
        ['PHPUnit', 8, true, 'https://phpunit.readthedocs.io/en/8.5', ''],
        ['Codeception', 6, false, 'https://codeception.com/docs', ''],
        ['Composer', 5, true, 'https://getcomposer.org/doc/', ''],
        ['Inertia.js', 0, false, 'https://inertiajs.com/', ''],
    ],
    'PHP CRM' => [
    ...
    'PHP CMS' => [
        ...
        ['DokuWiki', 7, false, 'https://www.dokuwiki.org/manual', ''],
    ],
    'Collaboration' => [
        ...
        ['Git', 9, true, 'https://git-scm.com/doc', ''],
    ...
    'Operating Systems' => [
        ...
        ['Debian', 9, true, 'https://www.debian.org/doc', ''],
